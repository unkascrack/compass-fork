...
public interface Property extends Serializable {
    ...
    public static enum Store {
        ...
        public static String toString(Store propertyStore) {
            if (propertyStore == Store.NO) {
                return "no";
            } else if (propertyStore == Store.YES) {
                return "yes";
            } else if (propertyStore == Store.COMPRESS) {
                return "compress";
            }
    ...
    public static enum Index {
         ...
         * contents provided it is {@link org.compass.core.Property.Store stored}.
         */
        NO,
        ...
        public static String toString(Index propertyIndex) {
            if (propertyIndex == Index.NO) {
                return "no";
            } else if (propertyIndex == Index.ANALYZED) {
                return "analyzed";
            } else if (propertyIndex == Index.NOT_ANALYZED) {
                return "not_analyzed";
            } else if (propertyIndex == Index.TOKENIZED) {
                return "tokenized";
            } else if (propertyIndex == Index.UN_TOKENIZED) {
                return "un_tokenized";
            }
    ...
    public static enum TermVector {
        ...
        public static String toString(TermVector propertyTermVector) {
            if (propertyTermVector == TermVector.NO) {
                return "no";
            } else if (propertyTermVector == TermVector.YES) {
                return "yes";
            } else if (propertyTermVector == TermVector.WITH_POSITIONS) {
                return "positions";
            } else if (propertyTermVector == TermVector.WITH_OFFSETS) {
                return "offsets";
            } else if (propertyTermVector == TermVector.WITH_POSITIONS_OFFSETS) {
