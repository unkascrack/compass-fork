...
public interface CompassQuery {
    ...
    /**
     * An extension to the {@link org.compass.core.CompassQuery} interface. Handles special span
     * queries.
     *
     * @author kimchy
     */
     ...
     * is created using {@link Compass#queryBuilder()}.
     */
     ...
     * advance using the {@link #addSort(String, org.compass.core.CompassQuery.SortPropertyType)}.
     * <p>
     ...
     * {@link org.compass.core.CompassQuery#isSuggested()}.
     */
