...
public class LuceneEnvironment {
    ...
    public static abstract class Analyzer {
         ...
         * qualified class of the analyzer ({@link org.compass.core.lucene.LuceneEnvironment.Analyzer} or an instnace of it.
         *
         ...
         * configured using the {@link org.compass.core.lucene.LuceneEnvironment.AnalyzerFilter} configuration settings.
         */
    ...
    public static abstract class LockFactory {
        ...
        /**
         * The type of the lock factory. Can either hold values stated at {@link org.compass.core.lucene.LuceneEnvironment.LockFactory.Type} or
        ...
        /**
         * Certain implementation (such as {@link org.compass.core.lucene.LuceneEnvironment.LockFactory.Type#SIMPLE_FS} or {@link org.compass.core.lucene.LuceneEnvironment.LockFactory.Type#NATIVE_FS})
