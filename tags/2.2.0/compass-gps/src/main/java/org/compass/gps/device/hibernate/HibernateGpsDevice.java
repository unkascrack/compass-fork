 ...
 *
 * <p>Indexing uses {@link org.compass.gps.device.hibernate.entities.HibernateEntitiesLocator} to locate all the entities that can be
 ...
 * {@link org.compass.gps.device.hibernate.indexer.HibernateIndexEntitiesIndexer}. It has two different implementation, the
