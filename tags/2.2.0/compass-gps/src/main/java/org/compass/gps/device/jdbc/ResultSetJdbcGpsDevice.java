...
public class ResultSetJdbcGpsDevice extends AbstractJdbcActiveMirrorGpsDevice {
     ...
     * mappings that implement the {@link org.compass.gps.device.jdbc.mapping.AutoGenerateMapping}, auto detection
     * of version column jdbc type, and {@link org.compass.gps.device.jdbc.snapshot.JdbcSnapshot} loading (using the
    ...
    /**
     * Saves the {@link org.compass.gps.device.jdbc.snapshot.JdbcSnapshot}.
     */
