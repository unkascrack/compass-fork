 ...
 * implement the {@link org.compass.annotations.Searchable} annotation.
 *
 ...
 * acheived by marking the all the inheritance tree classes as {@link org.compass.annotations.Searchable}.
 *
...
public @interface Searchable {
     ...
     * inhertis all it's base class and interface mappings, means that the same result can be
     * acheived by marking the all the inheritance tree classes as {@link org.compass.annotations.Searchable}, in a
     * more performant way.
     *
