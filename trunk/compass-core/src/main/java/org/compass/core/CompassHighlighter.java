...
public interface CompassHighlighter {
    ...
    public static enum TextTokenizer {
        ...
        public static String toString(TextTokenizer textTokenizer) {
            if (textTokenizer == TextTokenizer.ANALYZER) {
                return "analyzer";
            } else if (textTokenizer == TextTokenizer.TERM_VECTOR) {
                return "term_vector";
            } else if (textTokenizer == TextTokenizer.AUTO) {
                return "auto";
            }
     ...
     * (see {@link org.compass.core.CompassHighlighter.TextTokenizer}).
     * 
     * @param analyzerName
    ...
    /**
     * Sets the analyzer that will be used if analysis of the text is needed
     * (see {@link org.compass.core.CompassHighlighter.TextTokenizer}). Uses the resource to derive the analyzer
