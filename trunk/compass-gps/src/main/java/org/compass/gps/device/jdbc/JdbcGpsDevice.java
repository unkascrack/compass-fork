...
public interface JdbcGpsDevice extends CompassGpsDevice {
    ...
    /**
     * Returns the {@link org.compass.gps.device.jdbc.dialect.JdbcDialect} that will be used when executing
    ...
    /**
     * Sets the {@link org.compass.gps.device.jdbc.dialect.JdbcDialect} that will be used when executing operations
