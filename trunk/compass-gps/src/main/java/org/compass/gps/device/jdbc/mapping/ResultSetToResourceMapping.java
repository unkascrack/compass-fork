 ...
 * mapping ({@link VersionColumnMapping})
 * is required.
 * 
 * @author kimchy
 */
public class ResultSetToResourceMapping {
     ...
     * {@link #addIdMapping(org.compass.gps.device.jdbc.mapping.ColumnToPropertyMapping)} to add them.
     * <p>
     * Indexing of unmapped columns is diasabled by default.
     * 
     * @param alias
    ...
    /**
     * Returns a list of all the {@link org.compass.gps.device.jdbc.mapping.ColumnMapping}s that are mapped to the
     * column name.
     * 
     * @param columnName
     *            The column name for the mapped columns.
     * @return A list of all the {@link org.compass.gps.device.jdbc.mapping.ColumnMapping}s.
     */
    ...
    /**
     * Adds the array of {@link org.compass.gps.device.jdbc.mapping.ColumnToPropertyMapping}s which acts as the id
     * column mappings.
     * 
     * @param idMappingsArr
     *            An array of {@link org.compass.gps.device.jdbc.mapping.ColumnToPropertyMapping}s to add.
     */
    ...
    /**
     * Adds of array of {@link org.compass.gps.device.jdbc.mapping.ColumnToPropertyMapping}s which acts as the data
     * column mappings.
     * 
    ...
    /**
     * Adds an array of {@link org.compass.gps.device.jdbc.mapping.ColumnToPropertyMapping}s which acts as the
