 ...
 *
 * <p>Indexing uses {@link org.compass.gps.device.jpa.entities.JpaEntitiesLocator} to locate all the entities that can be
 ...
 * org.compass.gps.device.jpa.entities.JpaEntitiesLocatorDetector} to auto detect the correct locator (which defaults to the ({@link
 ...
 * inject global event listeners. If no {@link org.compass.gps.device.jpa.lifecycle.JpaEntityLifecycleInjector} is defined, the device will
 * try to autodetect the injector based on the current support for specific JPA implementations using
 * the {@link org.compass.gps.device.jpa.lifecycle.JpaEntityLifecycleInjectorDetector}. See its javadoc for a list of the current JPA
...
public class JpaGpsDevice extends AbstractParallelGpsDevice implements PassiveMirrorGpsDevice {
     ...
     *
     * The native extractor is mainly used for specialized {@link org.compass.gps.device.jpa.lifecycle.JpaEntityLifecycleInjector}
     * and {@link org.compass.gps.device.jpa.entities.JpaEntitiesLocator}.
     */
     ...
     * listeners using either the provided {@link org.compass.gps.device.jpa.lifecycle.JpaEntityLifecycleInjector}, or if not
     * set, using the {@link org.compass.gps.device.jpa.lifecycle.JpaEntityLifecycleInjectorDetector}. Defaults to <code>false</code>.
     */
     ...
     * {@link org.compass.gps.device.jpa.entities.JpaEntitiesLocatorDetector} to auto detect that correct one.
     */
     ...
     * entity class. The same as {@link #setIndexQueryProvider(Class, org.compass.gps.device.jpa.queryprovider.JpaQueryProvider)}
     ...
     * entity name. The same as {@link #setIndexQueryProvider(String, org.compass.gps.device.jpa.queryprovider.JpaQueryProvider)}
     * using {@link org.compass.gps.device.jpa.queryprovider.DefaultJpaQueryProvider}.
     *
     * <p>Certain JPA implementations have specific query providers with possible
     * enhanced functionality in regards to indexing. When using this method
