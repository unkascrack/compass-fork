 ...
 * {@link IndexEntity}ies. The
 * {@link IndexEntitiesPartitioner} is
 * then used in order to partition the index entities into several groups
 * that can be parallel indexed. An {@link IndexEntitiesIndexer}
...
public abstract class AbstractParallelGpsDevice extends AbstractGpsDevice {
     ...
     * indexeable entities and uses the {@link IndexEntitiesPartitioner}
